  ...
  return (
    <div
      ...
      <Card
        ...
        <div style={{ color: "#666", marginBottom: 16, fontSize: 12, fontFamily: "monospace" }}>
          > CONFIGURE_TRANSLATION_
        </div>
        <Form layout="vertical">
          <Form.Item
            label={<span style={{ fontWeight: 700, fontFamily: "monospace", fontSize: 12 }}>
              [ SOURCE_LANG ]
            </span>}
            ...
            <Select
              ...
              style={{ width: "100%", border: "2px solid #000", borderRadius: 0, fontFamily: "monospace" }}
            />
          </Form.Item>
          <Form.Item
            label={<span style={{ fontWeight: 700, fontFamily: "monospace", fontSize: 12 }}>
          ...
          {config.tp === TP.OPENAI && (
            <>
              <div
                style={{ borderTop: "2px solid #000", margin: "16px 0 12px 0" }}
              />
              <Form.Item
                label={<span style={{ fontWeight: 700, fontFamily: "monospace", fontSize: 12 }}>
                  [ API_KEY ]
